                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <b class="ml-2">Adresse Crypto de l'Acheteur :</b> <span class="text-info"> <?= wordwrap($commands['cryptoAdresseAch'],10) ?></span> <br>
                        </div>
                        <!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <?php endif;?>
                                <h5 class="text-bold text-muted">Adresse Crypto: <?= $commands['cryptoAdresseAch']?></h5>
                        ...
                        <div class="row no-print">
                            <input type="hidden" value="<?=$commands['id_buying']?>" id="id_buyingCryptoFiat" name= "id_buyingCryptoFiat">
                            ...
                            <div class="col-12">
                                ...
                                <?php if($commands['statut_buy_exchange'] == 'process'):?>
                                    ...
                                    <button type="button" class="btn btn-danger float-right mr-2" id="btn_cancel_order_achat_cryptofiat"><i class="far fa-credit-card"></i>
                                        Rejeter
                                    </button>
                                    <button type="button" class="btn btn-primary float-right" style="margin-right: 5px;" id="btn_validate_order_achat_cryptofiat">
