        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url() ?>exchange/postView" method="post">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputEstimatedBudget">Déposer</label>
                                <div class="row ml-1 mr-1">
                                    <input type="text" class="form-control col-sm-6 col-md-6 mb-1 text-info"
                                           placeholder="Votre adresse BTC ou USDT(ERC20)" name="cryptoAdresse"
                                           value="<?= $data["cryptoAdresse"] ?>" required>
                                    <input type="text" class="form-control col-sm-6 col-md-6 text-info"
                                           placeholder="Votre Hash" name="hash" value="<?= $data["hash"] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="moyen_paiement">
                                    <?php if ($data["moyen_paiement"] == "244"): ?>
                                        <option selected value="<?= $data["moyen_paiement"] ?>">MPESA</option>
                                    <?php elseif ($data["moyen_paiement"] == "243"): ?>
                                        <option selected value="<?= $data["moyen_paiement"] ?>">Airtel Money</option>
                                    <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a onclick="return confirm('Etes-vous sûr d\'annuler votre ordre de vente ?')"
                                       href="<?= base_url() ?>exchange/cryptoTofiat" title="Annuler"
