...
<body class="hold-transition sidebar-collapse layout-top-nav">
    <div id="google_translate_element2"></div><!-- translate -->
<div class="wrapper">
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand-md navbar-dark elevation-2 fixed-top" style="background-color: #273c75; border-color:#192a56;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url()?>buying" class="nav-link" title="Acheter les crypto monaies contre du Fiat ">ACHETER</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link exchangeNonDispo" title="Vendre les crypto monnaies contre du Fiat">VENDRE</a>
                    </li>
                    <?php else: ?>
                    <li class="nav-item">
                        <a href="#" class="nav-link operationAchatVente" title="Vous dévez vous connecter ou vous inscrire ">ACHETER</a>
                    </li>
                    <li class="#" class="nav-link">
                        <a href="#" class="nav-link exchangeNonDispo" title="Vous dévez vous connecter ou vous inscrire">VENDRE</a>
                    </li>
                    <?php endif;?>
            ...
            <ul class=" order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                ...
                <li class="nav-item dropdown">
                    <?php if(isset($data['id_abonne']) && $data['role_utilisateur'] != 'abonne'):?> 
                ...
                <?php if(isset($data['id_abonne'])):?>
                    <li class="nav-item">
                        ...
                        <img src="<?= base_url() ?>assets/img/users/<?=$data['photo_abonne'];?>" alt="<?= $data['prenom_abonne'];?>"
            ...
            <!-- Right navbar links -->
            <div class="collapse navbar-collapse order-1 order-lg-3 navbar-nav navbar-no-expand ml-auto" id="navbarCollapse">
                <ul class="navbar-nav">
                    <?php if(empty($data['id_abonne'])):?>
                    <li class="nav-item">
                        <a href="<?= base_url()?>register" class="nav-link" title="Inscrivez-vous pour commencer les achats et ventes de cripto monnaies">S'INSCRIRE</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= base_url()?>pages/connexion" class="nav-link" title="Connectez-vous">SE CONNECTER</a>
                    </li>
                    <?php else :?>
                        <li class="nav-item">
                        <a href="<?= base_url()?>register/myaccount" class="nav-link" title="Gérer votre compte"><?=ucfirst($data['prenom_abonne']);?>
                        </a>
                        </li>
                    <?php endif?>    
                </ul>
            </div>
                <a class="navbar-toggler order-1" type="button" data-widget="pushmenu" href="#" role="button" title="Menu">
