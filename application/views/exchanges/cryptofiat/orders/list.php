...
<div class="content-wrapper ">
    ...
    <section class="content-header">
        <div class="container mt-5">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="mt-2">Ordres d'achats Cryptos contre Fiat</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-striped table-hover">
                                ...
                                <?php foreach ($commandes as $row):?>
                                    <tr>
                                        ...
                                        <td><a href="<?= site_url('exchange/detailOrdersAchatCryptoFiat/'.$row->id_buying)?>" class="btn btn-sm btn-info">Détails</a></td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
                                <tfoot>
