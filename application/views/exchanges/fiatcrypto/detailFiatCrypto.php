                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <b class="ml-2">ID Transaction :</b> <span class="text-info"> <?= wordwrap($commands['id_transaction'],10) ?></span> <br>
                        </div>
                        <!-- /.row -->
                        ...
                        <div class="row no-print">
                            <input type="hidden" value="<?=$commands['id_exchange']?>" id="id_exchangeFiatCrypto" name= "id_exchangeFiatCrypto">
                            ...
                            <div class="col-12">
                                ...
                                <?php if($commands['statut_demande'] == 'process'):?>
                                    <button type="button" class="btn btn-danger float-right mr-2" id="btn_cancel__exchange_fiat"><i class="far fa-credit-card"></i>
                                        Rejeter
                                    </button>
                                    <button type="button" class="btn btn-primary float-right" style="margin-right: 5px;" id="btn_validate_exchange_fiat">
                                        <i class="fas fa-check" ></i>Accepter
                                    </button>

                                    <a href="<?=base_url('exchange/fetchFiatCrypto')?>" class="btn btn-success float-right mr-2"><i class="far fa-credit-card"></i>
                                        Liste complète
                                    </a>
                                <?php elseif($commands['statut_demande'] == 'confirm' || $commands['statut_demande'] == 'cancel'):?>
                                    <a href="<?=base_url('exchange/fetchFiatCrypto')?>" class="btn btn-success float-right"><i class="far fa-credit-card"></i>
                                        Liste complète
                                    </a>
                                <?php endif;?>
                            </div>
