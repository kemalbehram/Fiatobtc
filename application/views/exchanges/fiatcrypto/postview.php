        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url() ?>exchange/fiatTocrypto" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class=" col-sm-12 col-md-12">
                                        <label for="inputEstimatedBudget">Votre ID de Transaction</label>
                                        <input type="text"  readonly class="form-control text-primary" name="id_transaction" value="<?= $data["id_transaction"] ?>"
                                               required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a onclick="return confirm('Etes-vous sûr d\'annuler votre ordre de vente ?')" href="<?= base_url()?>exchange/fiatTocrypto" title="Annuler" class="btn btn-danger float-left">Annuler</a>
